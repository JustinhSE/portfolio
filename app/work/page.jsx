...
const projects = [
  {
    ...
    stack: [{ name: "React + TypeScript" }, { name: "Tailwind CSS" }, { name: "Google Firebase" }, { name: "Cloud Firestore" }, ],
    image: "/cook.png",
    live: "",
  ...
  },
  {
    ...
    title: "project 4",
    description: "Bible Verse Similarity Finder",
    stack: [{ name: "Python" }, { name: "Sklearn" }, { name: "NLTK" }, { name: "Flask" }, ],
    image: "/project4.png",
    live: "https://bible-verse-finder-1.onrender.com/",
